    ...
    return(
        <div className=" min-h-screen w-screen bg-[#F0EDE8]">
            ...
            <div className="flex ">
                ...
                <div className="flex-col left mt-52 ml-28">

                    <h1 className="text-[#212121] font-NewSpirit text-7xl "> Contact Me. </h1>

                    <h2 className="text-[#373737] font-SegoeUI text-2xl w-[33rem] mt-4"> 
                        ...
                        <Image src={head} className="-mt-[10.15rem] -ml-20" />


                </div>

                <div className="flex flex-col  border-4 border-black w-[32rem] h-[39rem] mt-52 ml-11">

                    <Image src={circles} className="object-contain self-start mt-2 ml-6" />
                    
                    <div className="line bg-black w-[31.5rem] h-1 mt-2">  </div>
